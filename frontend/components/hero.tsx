      ...
      <div className="relative z-10 flex max-w-3xl flex-col items-center text-center">
        ...
        <div className="mb-8 flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5">
          ...
          <span className="text-xs font-medium tracking-wide text-primary">
            BUILT BY EPICBOTCODERS
          </span>
        </div>

        {/* Headline */}
        <h1 className="text-balance text-5xl font-extrabold leading-tight tracking-tight text-foreground md:text-7xl">
          Track LeetCode.
          <br />
        ...
        <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl">
          Help your community stay accountable, showcase coding progress, and
          drive engagement — all without leaving your server.
        </p>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-14 rounded-xl border-border px-8 text-base font-medium text-foreground transition-colors hover:border-primary/50 hover:bg-secondary"
          >
            <a
        ...
        <div className="mt-14 w-full max-w-md">
          <div className="rounded-xl border border-border bg-card p-4">
            ...
            <code className="block font-mono text-sm leading-relaxed text-muted-foreground">
              <span className="text-primary">{">"}</span>{" "}
              <span className="text-foreground">/adduser</span> username:surajstaabi
              <br />
              <span className="text-primary/70">{"  "}Tracking started for surajstaabi!</span>
              <br />
              <span className="text-primary">{">"}</span>{" "}
              <span className="text-foreground">/check</span>
              <br />
              <span className="text-primary">{"  "}surajstaabi: Solved "Two Sum" (Easy) 🔥 42 day streak!</span>
            </code>
          </div>
        </div>
      </div>
